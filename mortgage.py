...
Play project to determine how long it will take
...
out = open('schedule.txt', 'w') # open a file for writitng - this will truncate a file if this exists (use 'a' to append)
